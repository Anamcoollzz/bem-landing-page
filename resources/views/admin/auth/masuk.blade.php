...
<head>
  ...
  <title>Masuk | BEM FASILKOM UNEJ</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>BEM </b>FASILKOM UNEJ</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masuk untuk mengakses menu</p>

    <form action="{{ route('loginindong') }}" method="post">
      @csrf
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input @if(old('remember_me')) checked="checked" @endif name="remember_me" type="checkbox"> Ingat Saya
            </label>
          </div>
        </div>
        <!-- /.col -->
