...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Kajian Strategis</h1>
    <ol class="breadcrumb">
      <li><a href="{{ url('/') }}"><i class="fa fa-dashboard"></i> Dasbor</a></li>
      <li class="active">Kajian Strategis</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Kajian Strategis</h3>
            <a href="{{ route('kajian-strategis.create') }}" class="btn btn-primary btn-sm btn-flat pull-right">Tambah</a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="datatable" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $d->hit }}</td>
                  <td>
                    <a href="{{ route('kajian-strategis.edit', [$d->id]) }}" class="btn btn-primary btn-flat">Ubah</a>
                    <a onclick="hapus('{{ route('kajian-strategis.destroy', [$d->id]) }}')" class="btn btn-danger btn-flat">Hapus</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
