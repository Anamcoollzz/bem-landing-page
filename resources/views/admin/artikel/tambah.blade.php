      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="{{ route('artikel.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <textarea required="required" name="isi" class="textarea wysihtml5" placeholder="Isikan artikel" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('isi') }}</textarea>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
